...
export class AwsUploader implements IAwsUploader {


    async uploadVideo(videoBinary: Uint8Array): Promise<{ publicUrl: string }> {
    ...
    async uploadImage (imageBinary: Buffer, imageName: string): Promise<{ publicUrl: string }> {
